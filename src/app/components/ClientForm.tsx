...
export default function ClientForm({
  ...
  return (
    ...
    >
      ...
      {/* BLOC 1 : IDENTITE LEGALE & COMMERCIALE */}
      ...
      {/* BLOC 2 : PARAMETRES FINANCIERS & COMPTABLES */}
      <section id="finance" className="form-section mb-14">
        ...
        <Card id="parametres-comptables" title="Paramètres Comptables" subtitle="Configuration comptable et de paiement" icon={<DollarOutlined style={{ fontSize: '18px', color: 'var(--primary)' }} />}>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Form.Item label={<span style={ls}>Statut de TVA {req}</span>} name="statusTVA" rules={[{ required: true, message: 'Champ requis' }]} className={fc('statusTVA')}>
                    ...
                    label: (
                      <div className="flex items-center justify-between pr-4" style={{ width: '100%' }}>
                        ...
                        <Popconfirm
                          ...
                          description={
                            <div>
                              <p style={{ ...ls, marginBottom: '4px' }}>Êtes-vous sûr de vouloir supprimer {country.name} ?</p>
